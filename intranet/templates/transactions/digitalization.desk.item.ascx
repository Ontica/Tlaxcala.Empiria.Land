...
<tr class="<%# ((int) DataBinder.Eval(Container, "ItemIndex") % 2 == 0 ? String.Empty  : "oddDataRow") %>" onmouseover="dataGridRowSelect(this, true);" onmouseout="dataGridRowSelect(this, false);">
	...
	<td style="white-space:nowrap;width:40%;display:<%#Empiria.Land.WebApp.ProcessControlDashboard.ShowDigitalizationTakeTransactionButton(DataBinder.Eval(Container, "DataItem")) ? "inline" : "none"%>">			
		<br />
