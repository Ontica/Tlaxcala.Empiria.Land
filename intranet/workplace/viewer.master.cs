...
*  Type      : WorkplaceViewerMasterPage                        Pattern  : Master Web Page                   *
*  Version   : 3.0                                              License  : Please read license.txt file      *
*                                                                                                            *
*  Summary   : Master page for viewer items.                                                                 *
*                                                                                                            *
...
namespace Empiria.Web.UI.Workplace {
  ...
  public partial class ViewerMasterPage : MasterWebPage {
