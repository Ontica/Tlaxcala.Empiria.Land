<%@ Control Language="C#" AutoEventWireup="false" Inherits="Empiria.Land.WebApp.AppendRecordingActEditorControl" Codebehind="append.recording.act.editor.control.ascx.cs" %>
