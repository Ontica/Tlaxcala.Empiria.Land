<%@ Page Language="C#" EnableViewState="true"  EnableSessionState="true" MasterPageFile="~/workplace/dashboard.master" AutoEventWireup="true" Inherits="Empiria.Land.WebApp.RecordingBooksSearchDashboard" CodeFile="recording.books.search.dashboard.aspx.cs" %>
