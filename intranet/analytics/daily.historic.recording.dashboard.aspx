<%@ Page Language="C#" EnableViewState="true"  EnableSessionState="true" MasterPageFile="~/workplace/dashboard.master" AutoEventWireup="true" Inherits="Empiria.Land.WebApp.DailyHistoricRecordingDashboard" Codebehind="daily.historic.recording.dashboard.aspx.cs" %>
