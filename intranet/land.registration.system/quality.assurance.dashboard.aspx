<%@ Page Language="C#" EnableViewState="true"  EnableSessionState="true" MasterPageFile="~/workplace/dashboard.master" AutoEventWireup="true" Inherits="Empiria.Land.WebApp.QualityAssuranceDashboard" CodeFile="quality.assurance.dashboard.aspx.cs" %>
