<%@ Page Language="C#" AutoEventWireup="true" Inherits="Empiria.Land.WebApp.TransactionReturnEditor" Codebehind="transaction.return.editor.aspx.cs" %>
<!DOCTYPE html>
...
<body style="background-color:#fafafa; top:0; margin:0; margin-top:-14px; margin-left:-6px;">
  ...
  <div id="divContentAlwaysVisible">
    ...
    <table id="tabStripItemView_0" style="display:inline;">
      <tr>
        <td class="subTitle">Causales de la devolución del trámite</td>
      </tr>

      <tr>
        <td class="subTitle">Documento de devolución</td>
      </tr>
