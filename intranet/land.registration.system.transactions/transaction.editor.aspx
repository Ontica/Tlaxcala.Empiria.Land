...
<div id="divCanvas">
  ...
  <table class="tabStrip">
    <tr>
      ...
      <td id="tabStripItem_1" class="tabOff" style='display:<%=transaction.ComesFromAgencyExternalFilingSystem ? "none" : "inline"%>' onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Digitalización</td>
      <td id="tabStripItem_2" class="tabOff" style='display:<%=transaction.ComesFromAgencyExternalFilingSystem ? "inline" : "none"%>' onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Trámite en línea</td>
      <td id="tabStripItem_3" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Inscripción de documentos</td>
      <td id="tabStripItem_4" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Emisión de certificados</td>
      <td id="tabStripItem_5" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Devoluciones</td>
      <td id="tabStripItem_6" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Estado del trámite</td>
...
<tr style='display:<%=base.CanReceivePayment() ? "inline" : "none" %>'>
  ...
  <tr>
    ...
    <table id="tabStripItemView_2" class="editionTable" style="display:none">
      <tr>
        <td class="lastCell">
          <iframe id="ifraExternalTransactionHandler" style="z-index:99;left:0;top:0;"
                  marginheight="0" marginwidth="0" frameborder="0" scrolling="no"
                  src="../workplace/empty.page.aspx" width="90%" height="4000px" visible="true" >
          </iframe>
        </td>
        ...
        <td>
          ...
          <div style="text-align: right">
            <% if (!transaction.IsNew && base.CanCreateCertificate()) { %>
              ...
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <% } else if (base.IsTransactionReadyToSendToCitys()) { %>
              <br />
              <input class="button" type="button" value="Enviar certificado a SITYS" onclick="doOperation('sendCertificateToCITYS')" style="height:28px;width:144px" />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <% } %>
          </div>
        </td>
    ...
    <table id="tabStripItemView_6" class="editionTable" style="display:none">
      <tr>
        <td class="lastCell">
...
<div id="divBottomToolbar" style="display:none">
  ...
  function showEditors() {
    ...
    getElement('ifraExternalTransactionHandler').src = "./external.transaction.handler.aspx?transactionId=<%=transaction.Id%>";
    ...
    <% } else { %>
    getElement('ifraDigitalizationEditor').src = "../workplace/empty.page.aspx";
